		...
		.config([ '$componentLoaderProvider', '$locationProvider', '$ocLazyLoadProvider', function (
			...
			$componentLoaderProvider.setTemplateMapping(function ( name ) {
			 ...
			 $ocLazyLoadProvider.config({
											debug: true,
											events: true,
											modules: [{	name: 'app.dashboard',files: [ System.baseURL + '/components/dashboard/dashboard.module.es6.js']},
													  { name: 'app.promotions',files: [ System.baseURL + '/components/promotions/promotions.module.es6.js']}]
										});
